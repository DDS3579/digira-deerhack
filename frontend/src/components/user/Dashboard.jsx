...
import { MessageSquare, Newspaper, Calendar, MapPin, ArrowRight } from "lucide-react";
...
export default function Dashboard() {
  ...
  return (
    <div className="space-y-6">
      ...
      >
        <h1 className="text-3xl font-bold tracking-tight bg-gradient-to-r from-foreground to-foreground/70 bg-clip-text text-transparent">User Dashboard</h1>
        <p className="text-muted-foreground mt-1">
          Overview of updates, events, and complaints
        </p>
      </motion.div>

      {/* Updates (Samachar) Section */}
      <motion.div
      ...
      >
        ...
        <CardContent>
          {loading ? (
            ...
            <div className="space-y-4">
              {samachar.slice(0, 2).map((update, index) => (
                <div key={update.id || index}>
                  ...
                  {index < Math.min(samachar.length, 2) - 1 && (
