...
import { Mail, Calendar, User, MapPin, Clock } from "lucide-react";
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">
            View and manage community invitations
          </p>
        </div>
      </div>
              ...
              <Card key={invitation.id || index} className={upcoming ? "border-green-200 dark:border-green-800" : "opacity-75"}>
                ...
                <CardContent>
                  ...
                  <div className="space-y-2 text-xs text-muted-foreground">
                    ...
                    {invitation.invitee_count && (
                      <div className="text-xs text-muted-foreground">
                        Invited: {invitation.invitee_count} people
                      </div>
                    )}
                  </div>
                </CardContent>
